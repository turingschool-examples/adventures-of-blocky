describe.skip('World', function () {
  ...
  it.skip('should take the first argument and set it as the "width" property of the instantiated object');

  it.skip('should take the second argument and set it as the "height" property of the instantiated object');
